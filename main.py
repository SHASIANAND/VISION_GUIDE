...
def take_image(string):
    ...
    path= 'D:/VISION-THE-BLIND-master/VISION-THE-BLIND-master/faces'
    # cv2.imwrite(img_name, frame)
    img_counter += 1

    # time.sleep(2) # ML program

    if os.path.exists(os.path.join(path,img_name)): #delete the file
...
while True:
    ...
    # while i<6:
        with sr.Microphone() as source:
            ...
            audio = r.listen(source, timeout=60, phrase_time_limit=15)
